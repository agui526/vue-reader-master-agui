        ...
        <div class="detail-content" v-if="bookDetail">
			...
			<div v-if="!loading">
				<div class="detail-intro">
					<p :class="{show5: !showMore}" @click="showMore = !showMore">
						{{ bookDetail.intro }}
					</p>
				</div>
				...
				<div class="detail-like">
					<h3 class="like-title">喜欢这本书的人也喜欢</h3>
					<ul class="like-list">
						<li v-for="(item,index) in likeBooks" :key="index">
...
<script type="text/ecmascript-6">
	...
	import Rate from '@/components/link/Rate'
	import Similar from '@/components/link/Similar'
        ...
        methods: {
            getBookDetail(bookId) {
                ...
                axios.get(`${this.common.api}/booklist?id=${bookId}`).then(res => {
					...
					this.likeBooks = res.data.like.split('-')
